                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <ScrollReveal animation="fade-right">
                            <div>
                                ...
                                <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                                    Chuyên cung cấp tài khoản bản quyền giá rẻ, uy tín hàng đầu Việt Nam.
                                </p>

                                <div className="flex gap-4">
                                    <a href={`https://zalo.me/${process.env.NEXT_PUBLIC_ZALO_LINK || "0000000000"}`} className="bg-gray-800 p-2 rounded-lg hover:bg-indigo-600 transition-colors text-white">
                                        <Facebook className="w-5 h-5" />
                                    </a>
                                    <a href={`https://www.youtube.com/${process.env.NEXT_PUBLIC_YOTUBE}`} className="bg-gray-800 p-2 rounded-lg hover:bg-red-600 transition-colors text-white">
                                        <Youtube className="w-5 h-5" />
                                    </a>
                                    <a href={`https://www.instagram.com//${process.env.NEXT_PUBLIC_INTAGRAM}`} className="bg-gray-800 p-2 rounded-lg hover:bg-pink-600 transition-colors text-white">
                        ...
                        <ScrollReveal animation="fade-up" delay={100}>
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <Link href="/" className="flex items-center gap-2 text-sm hover:text-white transition-colors">
                        ...
                        <ScrollReveal animation="fade-up" delay={200}>
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li><a href="#" className="text-sm hover:text-white">Hướng dẫn mua hàng</a></li>
                                    <li><a href="#" className="text-sm hover:text-white">Chính sách bảo hành</a></li>
                                    <li><a href="#" className="text-sm hover:text-white">FAQ</a></li>
                                    <li><a href="#" className="text-sm hover:text-white">Điều khoản dịch vụ</a></li>
                                    <li><a href="#" className="text-sm hover:text-white">Chính sách bảo mật</a></li>
                                </ul>
                            </div>
                        </ScrollReveal>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="block text-xs text-gray-500">Hotline / Zalo</span>
                                            <span className="text-white font-medium">{process.env.NEXT_PUBLIC_PHONE_LH || "0000.000.000"}</span>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="block text-xs text-gray-500">Email hỗ trợ</span>
                                            <span className="text-white font-medium">{process.env.NEXT_PUBLIC_MAIL_LH || "test@gmail.com"}</span>
                                        </div>
                                    </li>
